...
public class ProtectAlgoTest {
    ...
    public void canRunProtectAlgoOnMinimalTestData() {
        ...
        assertNotNull(algo.run(TestOrangeFactory.createMinimalTestOrangeRecord(), ExperimentType.WHOLE_GENOME));
    }
    ...
    public void canRunProtectAlgoOnProperTestData() {
        ...
        assertNotNull(algo.run(TestOrangeFactory.createProperTestOrangeRecord(), ExperimentType.WHOLE_GENOME));
    }
