...
public class ProtectEvidenceComparatorTest {
    ...
    public void canSortProtectEvidence() {
        ProtectEvidence evidence1 = TestProtectFactory.builder().reported(true).gene("A").build();
        ProtectEvidence evidence2 = TestProtectFactory.builder().reported(false).gene("A").build();
        ProtectEvidence evidence3 = TestProtectFactory.builder().reported(true).gene("B").build();
