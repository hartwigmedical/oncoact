...
public class LimsTest {
    ...
    public void canReadHospitalData() {
        LimsJsonSampleData sample = LimsTestUtil.createLimsSampleDataBuilder()
                .sampleId(TUMOR_SAMPLE_ID)
                .tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .cohort(TEST_COHORT)
                .build();
        ...
        HospitalModel testHospitalModel = ImmutableHospitalModel.builder()
                .putHospitalAddressMap("1",
                        ImmutableHospitalAddress.builder().hospitalName("Name").hospitalZip("Zip").hospitalCity("City").build())
    ...
    public void canExtractLimsViralInsertionsChoice() {
        LimsJsonSampleData sampleDataTrue = LimsTestUtil.createLimsSampleDataBuilder()
                .tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId(TUMOR_SAMPLE_ID)
                .cohort(TEST_COHORT)
                .reportViralPresence(true)
                .build();
        LimsJsonSampleData sampleDataFalse = LimsTestUtil.createLimsSampleDataBuilder()
                .tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId(TUMOR_SAMPLE_ID)
                .cohort(TEST_COHORT)
                .reportViralPresence(false)
    ...
    public void canExtractLimsReportableGermlineVariants() {
        LimsJsonSampleData sampleDataCPCTTrue = LimsTestUtil.createLimsSampleDataBuilder()
                .tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId("CPCT02991111T")
                .reportGermlineVariants(true)
                .cohort("CPCT")
                .build();
        LimsJsonSampleData sampleDataCPCTFalse = LimsTestUtil.createLimsSampleDataBuilder()
                .tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId("CPCT02991111T")
        ...
        LimsJsonSampleData sampleDataWIDETrue = LimsTestUtil.createLimsSampleDataBuilder()
                .tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId("WIDE01010000T")
                .reportGermlineVariants(true)
                .cohort("WIDE")
                .build();
        LimsJsonSampleData sampleDataWIDEFalse = LimsTestUtil.createLimsSampleDataBuilder()
                .tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId("WIDE01010000T")
                .reportGermlineVariants(false)
                .cohort("WIDE")
    ...
    public void missingOrMalformedShallowSeqDataForSampleYieldsNA() {
        LimsJsonSampleData sampleData1 =
                LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE).shallowSeq(true).build();
    ...
    public void canRetrievePathologyPercentageForSample() {
        LimsJsonSampleData sampleData1 = LimsTestUtil.createLimsSampleDataBuilder()
                .tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .shallowSeq(false)
        ...
        LimsJsonSampleData sampleData2 = LimsTestUtil.createLimsSampleDataBuilder()
                .tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .shallowSeq(false)
    ...
    private static Lims buildTestLimsWithSampleAndShallowSeq(@NotNull LimsJsonSampleData sample, @NotNull String shallowSeqPurity,
        ...
        shallowSeqDataPerSampleBarcode.put(sample.tumorBarcode(),
                ImmutableLimsShallowSeqData.builder()
                        ...
                        .purityShallowSeq(shallowSeqPurity)
