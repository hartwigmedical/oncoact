package com.hartwig.oncoact.common.lims;
...
import com.hartwig.oncoact.common.lims.cohort.ImmutableLimsCohortModel;
import com.hartwig.oncoact.common.lims.cohort.LimsCohortConfig;
import com.hartwig.oncoact.common.lims.cohort.LimsCohortModel;
...
import com.hartwig.oncoact.common.lims.hospital.HospitalModel;
import com.hartwig.oncoact.common.lims.hospital.ImmutableHospitalAddress;
import com.hartwig.oncoact.common.lims.hospital.ImmutableHospitalModel;
...
public class LimsTest {
    ...
    public void canReadProperlyDefinedSample() {
        ...
        LimsJsonSampleData sampleData = LimsTestUtil.createLimsSampleDataBuilder().sampleId(TUMOR_SAMPLE_ID)
                .patientId(patientId)
    ...
    public void canReadHospitalData() {
        LimsJsonSampleData sample =
                LimsTestUtil.createLimsSampleDataBuilder().sampleId(TUMOR_SAMPLE_ID).tumorBarcode(TUMOR_SAMPLE_BARCODE).cohort(TEST_COHORT).build();
    ...
    public void canExtractLimsViralInsertionsChoice() {
        LimsJsonSampleData sampleDataTrue = LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId(TUMOR_SAMPLE_ID)
                .cohort(TEST_COHORT)
                .reportViralPresence(true)
                .build();
        LimsJsonSampleData sampleDataFalse = LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId(TUMOR_SAMPLE_ID)
                .cohort(TEST_COHORT)
                .reportViralPresence(false)
                .build();
    ...
    public void canExtractLimsReportableGermlineVariants() {
        LimsJsonSampleData sampleDataCPCTTrue = LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId("CPCT02991111T")
                .reportGermlineVariants(true)
                .cohort("CPCT")
                .build();
        LimsJsonSampleData sampleDataCPCTFalse = LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId("CPCT02991111T")
                .reportGermlineVariants(false)
                .cohort("CPCT")
                .build();

        LimsJsonSampleData sampleDataWIDETrue = LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId("WIDE01010000T")
                .reportGermlineVariants(true)
                .cohort("WIDE")
                .build();
        LimsJsonSampleData sampleDataWIDEFalse = LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .sampleId("WIDE01010000T")
                .reportGermlineVariants(false)
                .cohort("WIDE")
                .build();
    ...
    public void missingOrMalformedShallowSeqDataForSampleYieldsNA() {
        LimsJsonSampleData sampleData1 = LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE).shallowSeq(true).build();
        ...
        LimsJsonSampleData sampleData2 = LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE).shallowSeq(true).build();
    ...
    public void canRetrievePathologyPercentageForSample() {
        LimsJsonSampleData sampleData1 =
                LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE).shallowSeq(false).pathologyTumorPercentage("70").build();

        Lims lims1 = buildTestLimsWithSample(sampleData1);
        assertEquals(Lims.NOT_PERFORMED_STRING, lims1.purityShallowSeq(TUMOR_SAMPLE_BARCODE));
        assertEquals("70%", lims1.pathologyTumorPercentage(TUMOR_SAMPLE_BARCODE));

        LimsJsonSampleData sampleData2 = LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE)
                .shallowSeq(false)
    ...
    public void canRetrieveShallowSeqPurityForSample() {
        LimsJsonSampleData sampleData = LimsTestUtil.createLimsSampleDataBuilder().tumorBarcode(TUMOR_SAMPLE_BARCODE).shallowSeq(true).build();
