...
public final class GeneCopyNumberFile
{
    ...
    {
        return new StringJoiner(PurpleCommon.DELIMITER, "", "")
                .add("chromosome")
                .add("start")
                .add("end")
                .add("gene")
    ...
    {
        return new StringJoiner(PurpleCommon.DELIMITER).add(geneCopyNumber.chromosome())
    ...
    static List<GeneCopyNumber> fromLines(final List<String> lines)
    {
        ...
        {
            String[] values = line.split(PurpleCommon.DELIMITER, -1);
