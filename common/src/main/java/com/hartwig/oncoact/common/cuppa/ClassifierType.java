package com.hartwig.oncoact.common.cuppa;

import static com.hartwig.oncoact.common.cuppa.DataTypes.DATA_TYPE_COMBINED;
import static com.hartwig.oncoact.common.cuppa.DataTypes.DATA_TYPE_DNA_COMBINED;
import static com.hartwig.oncoact.common.cuppa.DataTypes.DATA_TYPE_RNA_COMBINED;
...
public enum ClassifierType
{
    ...
    {
        if(classiferType.equals(CuppaDataFile.OLD_DATATYPE_SNV_PAIRWISE)) // backwards compatibility (earlier than 1.7)
            return SNV_96_PAIRWISE;

        if(classiferType.equals(CuppaDataFile.OLD_DATATYPE_GEN_POS_SIMILARITY)) // as above
