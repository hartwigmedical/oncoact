...
public class AltTranscriptReportableInfo {
    ...
    public AltTranscriptReportableInfo(
            final String transName, final String hgvsCoding, final String hgvsProtein, final String effects, final PurpleCodingEffect codingEffect)
    {
        TransName = transName;
    ...
    public static AltTranscriptReportableInfo parse(final String transInfo)
    {
        ...
        return new AltTranscriptReportableInfo(
                transValues[0], transValues[1], transValues[2], transValues[3], PurpleCodingEffect.valueOf(transValues[4]));
    }
    ...
    public static PurpleCodingEffect firstOtherCodingEffect(final String otherReportedEffects)
    {
        if(otherReportedEffects.isEmpty())
