...
public class FailedDBFileTest {
    ...
    public void canReadFailedDatabaseTsv() throws IOException {
        Map<String, FailedReason> failedDatabaseMap = FailedDBFile.buildFromTsv(FAIL_DATABASE_TSV);
        assertEquals(6, failedDatabaseMap.size());

        FailedReason technical_failure = failedDatabaseMap.get("technical_failure");
        ...
        FailedReason sufficient_tcp_qc_failure = failedDatabaseMap.get("sufficient_tcp_qc_failure");
        ...
        FailedReason insufficient_tcp_shallow_wgs = failedDatabaseMap.get("insufficient_tcp_shallow_wgs");
        ...
        FailedReason insufficient_tcp_deep_wgs = failedDatabaseMap.get("insufficient_tcp_deep_wgs");
        ...
        FailedReason insufficient_dna = failedDatabaseMap.get("insufficient_dna");
        ...
        FailedReason insufficient_dna_panel = failedDatabaseMap.get("insufficient_dna_panel");
