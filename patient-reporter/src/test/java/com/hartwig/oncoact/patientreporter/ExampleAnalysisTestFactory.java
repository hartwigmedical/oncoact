...
public final class ExampleAnalysisTestFactory {
    ...
    public static AnalysedPatientReport createWithCOLO829Data(@NotNull ExampleAnalysisConfig config, @NotNull PurpleQCStatus purpleQCStatus,
        ...
        Map<String, List<ProtectEvidence>> highLevel = createCOLO829HighLevelEvidence();
        Map<String, List<ProtectEvidence>> clinicalTrials = createCOLO829ClinicalTrials();
    ...
    @NotNull
    private static Map<String, List<ProtectEvidence>> createCOLO829HighLevelEvidence() {
        Map<String, List<ProtectEvidence>> highLevel = Maps.newHashMap();

        ImmutableProtectEvidence.Builder onLabelBuilder = TestProtectFactory.builder().onLabel(true).reported(true);
        highLevel.put("Atezolizumab + Cobimetinib + Vemurafenib", Lists.newArrayList(onLabelBuilder.gene("BRAF")
    ...
    @NotNull
    private static Map<String, List<ProtectEvidence>> createCOLO829ClinicalTrials() {
        Map<String, List<ProtectEvidence>> studies = Maps.newHashMap();

        ImmutableProtectEvidence.Builder trialBuilder = TestProtectFactory.builder().onLabel(true).reported(true);

        studies.put("COLUMBUS-AD", Lists.newArrayList(trialBuilder.gene("BRAF")
                .transcript("ENST00000288602")
                .isCanonical(true)
                .event("p.Val600Glu")
                .eventIsHighDriver(true)
